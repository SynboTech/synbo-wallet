...
class _HomePageState extends State<HomePage> {
  ...
  // Square/Feed 数据 (类似 Twitter/币安广场)
  final List<_SquarePost> _squarePosts = [
    _SquarePost(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Row(
            children: [
              _TextButton(label: 'Trending', onTap: () {}, isActive: true),
              const SizedBox(width: 4),
              _TextButton(label: 'Latest', onTap: () {}),
            ],
          ),
        ],
      ),
...
class _SquarePostCard extends StatelessWidget {
  const _SquarePostCard({required this.post, required this.isLast});
